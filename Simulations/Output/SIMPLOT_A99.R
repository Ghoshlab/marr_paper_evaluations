...
p_fdr <- ggplot(dat, aes(x=cond, y= FDR)) + geom_boxplot(fatten=1,lwd=0.3,outlier.size=0)+ xlab(expression(paste(pi[1])))+
  ggtitle(expression(paste(~rho[R],"=0.99,"~mu[R],"=3.89")))+ylim(0,0.10)+
...
p_ndr <- ggplot(datn, aes(x=cond, y= NDR)) + geom_boxplot(fatten=1,lwd=0.3,outlier.size=0)+ xlab(expression(paste(pi[1])))+ylab("1-NDR")+
  ggtitle(expression(paste(~rho[R],"=0.99,"~mu[R],"=3.89")))+
  theme(plot.title = element_text(hjust = 0.5))
...
p_pi0 <- ggplot(datpi0, aes(x=cond, y= pi10)) + geom_boxplot(fatten=1,lwd=0.3,outlier.size=0)+ xlab(expression(paste(pi[1])))+
  ...
  ggtitle(expression(paste(~rho[R],"=0.99,"~mu[R],"=3.89")))+ylim(-0.12,0.12)+
  theme(plot.title = element_text(hjust = 0.5))+
...
p_fdr <- ggplot(dat, aes(x=cond, y= FDR)) + geom_boxplot(fatten=1,lwd=0.3,outlier.size=0)+ xlab(expression(paste(pi[1])))+
  ggtitle(expression(paste(~rho[R],"=0.99,"~mu[R],"=4.01")))+ylim(0,0.10)+
  theme(plot.title = element_text(hjust = 0.5))+
  geom_hline(yintercept = 0.05,lwd=0.3)
...
#p <- ggplot(dat, aes(x=cond, y= FDR)) + geom_boxplot()+ xlab(expression(paste("Value is ", sigma,",", R^{2},'=',r2.value)))
p_ndr <- ggplot(datn, aes(x=cond, y= NDR)) + geom_boxplot(fatten=1,lwd=0.3,outlier.size=0)+ xlab(expression(paste(pi[1])))+ylab("1-NDR")+
  ggtitle(expression(paste(~rho[R],"=0.99,"~mu[R],"=4.01")))+
  theme(plot.title = element_text(hjust = 0.5))
...
p_pi0 <- ggplot(datpi0, aes(x=cond, y= pi10)) + geom_boxplot(fatten=1,lwd=0.3,outlier.size=0)+ xlab(expression(paste(pi[1])))+
  ylab(expression(paste(pi[1]-hat(pi[1]))))+
  ggtitle(expression(paste(~rho[R],"=0.99,"~mu[R],"=4.01")))+ylim(-0.12,0.12)+
  theme(plot.title = element_text(hjust = 0.5))+
  geom_hline(yintercept = 0,lwd=0.3)
...
p_fdr <- ggplot(dat, aes(x=cond, y= FDR)) + geom_boxplot(fatten=1,lwd=0.3,outlier.size=0)+ xlab(expression(paste(pi[1])))+
  ggtitle(expression(paste(~rho[R],"=0.99,"~mu[R],"=4.13")))+ylim(0,0.10)+
  theme(plot.title = element_text(hjust = 0.5))+
  geom_hline(yintercept = 0.05,lwd=0.3)
#~rho[R],"=0.99,"~mu[R],"=4.13"
p_ndr <- ggplot(datn, aes(x=cond, y= NDR)) + geom_boxplot(fatten=1,lwd=0.3,outlier.size=0)+ xlab(expression(paste(pi[1])))+ylab("1-NDR")+
  ggtitle(expression(paste(~rho[R],"=0.99,"~mu[R],"=4.13")))+
  theme(plot.title = element_text(hjust = 0.5))
...
p_pi0 <- ggplot(datpi0, aes(x=cond, y= pi10)) + geom_boxplot(fatten=1,lwd=0.3,outlier.size=0)+ xlab(expression(paste(pi[1])))+
  ylab(expression(paste(pi[1]-hat(pi[1]))))+
  ggtitle(expression(paste(~rho[R],"=0.99,"~mu[R],"=4.13")))+ylim(-0.12,0.12)+
  theme(plot.title = element_text(hjust = 0.5))+
  geom_hline(yintercept = 0,lwd=0.3)
...
ml2ndr <- marrangeGrob(list(plotlist1k[[3]],plotlist1k[[6]],plotlist1k[[9]]),
                       nrow = 1, ncol = 3,top=NULL)
#ggsave("../Wednesday_1211pres/MaRR0419_simplots.pdf", ml2,
#   width = 5.04, height = 3.78, units = "in")

ggsave("../MaRRsimA99/Fig5b.pdf", ml2fdr, width = 6.5, height = 3.78, units = "in")
# width = 5.04, height = 3.78, units = "in")

ggsave("../MaRRsimA99/Fig7b.pdf", mlpi0, width = 6.5, height = 3.78, units = "in")
#width = 5.04, height = 3.78, units = "in")

ggsave("../MaRRsimA99/Fig6b.pdf", ml2ndr, width = 6.5, height = 3.78, units = "in")
#width = 5.04, height = 3.78, units = "in")
