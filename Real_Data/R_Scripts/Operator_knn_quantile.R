...
options(warn=0)
#library(pcaMethods)
imputed_operator = ms_impute(filtered_operator, imputeMethod ="knn", k_knn = 5,n_pcs =5)

normalized_operator = ms_normalize(imputed_operator, normalizeMethod ="quantile",
...
save(saved_mshalf,file="../saved_objects/Operator_knn_quantile_load.R")
par(mfrow=c(3,1))
