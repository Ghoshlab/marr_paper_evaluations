...
imputed_metabolon = readRDS("Metabolon_bpca_object.rds")


normalized_metabolon = ms_normalize(imputed_metabolon, normalizeMethod ="quantile",
...
save(saved_metabolon,file="../saved_objects/Metabolon_bpca_quantile_load.R")
