...
normalized_replicates = ms_normalize(imputed_replicates, normalizeMethod ="quantile",
...
#setwd("~/Library/Mobile\ Documents/com~apple~CloudDocs/Metabo")
saved_charmion<-list(rabbcca=rabbcca,rabbcca2=rabbcca2,pabbcca=pabbcca,
                     rall=rall,rall2=rall2,rall3=rall3,pall=pall)

save(saved_charmion,file="../saved_objects/Charmion_BPCA_quantile_load.R")

#load("Charmion_random_load.R")
#saved_charmion$pall
rm(list = ls())
